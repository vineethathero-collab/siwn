...
const youthYoutubeDataEN = {
    ...
    popular: [
        { id: "UomBOw-x0Zc", title: "Dhamma Advice to Help the Younger Generation Succeed in Life", desc: "An inspiring Dhamma talk watched by thousands", thumb: "https://img.youtube.com/vi/UomBOw-x0Zc/0.jpg", type: "video" },
        { id: "ZMtJvYUMaSc", title: "Buddhism for Young People Seeking the Right Path", desc: "Authentic Dhamma communication for modern society", thumb: "https://img.youtube.com/vi/ZMtJvYUMaSc/0.jpg", type: "video" },
        { id: "niRsWkJ9Ccs", title: "Blessings and Protection for Peace in Every Family", desc: "A powerful chanting to bring peace and prosperity to the home", thumb: "https://img.youtube.com/vi/niRsWkJ9Ccs/0.jpg", type: "video" },
        { id: "QyQTGBvo6aQ", title: "Dhamma Classes for Developing Good Values in Children", desc: "A Dhamma guide specially prepared for young children", thumb: "https://img.youtube.com/vi/QyQTGBvo6aQ/0.jpg", type: "video" }
    ],
    shorts: [
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // 4. Attach Click Event to "Explore Full Library" CTA Button
  const ctaBtn = document.querySelector('a[href="library.html"]');
  if (ctaBtn) {
    ctaBtn.addEventListener("click", function (e) {
      e.preventDefault(); // Prevent navigating to empty library.html
      const msg = lang === "si" 
        ? "ළඟදීම ලබා ගත හැක! මෙම ඩිජිටල් පුස්තකාලය සූදානම් වෙමින් පවතී." 
        : "Coming Soon! The full library page is currently under construction.";
